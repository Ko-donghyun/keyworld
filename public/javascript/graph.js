...
function search(keyword) {
    ...
    var jsonData;
    var url;
    if (preKeyword != undefined) {

        url = "http://localhost:3000/keyword/extension?keyword=" + keyword + "&previousKeyword=" + preKeyword;
    } else {
        url = "http://localhost:3000/keyword?keyword=" + keyword;
    }
